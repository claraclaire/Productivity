...
<div class = "box1">
	...
	<div class = "policy1">
		...
		<div class = "insidecontent">
			...
			<h4>Supervisors Approval: <br><button class = "disapprove btn"><a href="{{URL::to('/company/disapprovejournal/'.$journal->journal)}}">Disapprove</a></button><button class = "approve btn"><a href="{{URL::to('/company/approvejournal/'.$journal->journalid)}}">Approve</a></button></h4>
