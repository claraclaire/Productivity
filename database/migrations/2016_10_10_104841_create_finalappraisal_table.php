...
class CreateFinalappraisalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('finalappraisal', function (Blueprint $table) {
            $table->increments('finalappraisalid');
