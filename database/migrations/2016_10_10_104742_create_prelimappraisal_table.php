...
class CreatePrelimappraisalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prelimappraisal', function (Blueprint $table) {
            $table->increments('prelimappraisalid');
